...
本项目基于[ProtobufBot](https://github.com/protobufbot)开发，使用`AGPLv3`开源，所有基于本项目的软件应使用`AGPLv3`开源
...
## 注意
- 默认的 service 有 **QPS<=2** 限制，如果需要增加QPS，需要自己部署相关服务（TNOODLE、WCADS、VSCUBE、RANK等），建议使用多台服务器分开进行部署
